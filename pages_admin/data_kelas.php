    ...
    >
      ...
      >
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../pages_admin/data_kelas.php">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
      ...
      <div class="container-fluid py-4">
        <div class="row">
          <div class="col-12">
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">        
                            <div
                              class="d-flex flex-column justify-content-center"
                            >
                              <h6 class="mb-0 text-sm"><?=$data_kelas['nama_kelas']?></h6>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle">
                          <span class="text-secondary text-xs font-weight-bold"
                            ><?=$data_kelas['kompetensi_keahlian']?></span
                          >
                        </td>
                        <td class="align-middle">
                          <a href="../backend/hapus_kelas.php?id_kelas=<?=$data_kelas['id_kelas']?>"
                            onclick="return confirm('Apakah anda yakin menghapus data ini?')" 
                            class="text-secondary font-weight-bold text-xs"
                            data-toggle="tooltip"
                            data-original-title="Hapus data">Hapus</a> | 
                          <a
                            href="edit_kelas.php?id_kelas=<?=$data_kelas['id_kelas']?>"
                            class="text-secondary font-weight-bold text-xs"
                            data-toggle="tooltip"
            ...
            <a class="btn bg-gradient-primary mt-4 w-30" href="tambah_kelas.php" type="button">Tambahkan Kelas</a>
          </div>
        </div>
      </div>
    </main>
