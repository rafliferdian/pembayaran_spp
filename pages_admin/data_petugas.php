  ...
  <body class="g-sidenav-show bg-gray-100">
    ...
    >
      ...
      >
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link " href="../pages_admin/data_siswa.php">
              <div
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../pages_admin/data_petugas.php">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
      ...
      >
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Data Petugas</h6>
          </nav>
          <div
      ...
      <div class="container-fluid py-4">
        <div class="row">
          <div class="col-12">
                ...
                <div class="table-responsive p-0">
                  <table class="table align-items-center mb-0">
                    ...
                    <tbody>
                      <?php
                        include "../koneksi.php";
                        $qry_petugas=mysqli_query($conn,"SELECT * FROM petugas ORDER BY nama_petugas ASC");
                        $no=0;
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">        
                            <div
                              class="d-flex flex-column justify-content-center"
                            >
                              <h6 class="mb-0 text-sm"><?=$data_petugas['nama_petugas']?></h6>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle">
                          <span class="text-secondary text-xs font-weight-bold"
                            ><?=$data_petugas['username']?></span
                          >
                        </td>
                        <td class="align-middle">
                          <span class="text-secondary text-xs font-weight-bold"
                            ><?=$data_petugas['password']?></span
                          >
                        </td>
                        <td class="align-middle">
                          <span class="text-secondary text-xs font-weight-bold"
                            ><?=$data_petugas['level']?></span
                          >
                        </td>
                        <td class="align-middle">
                          <a href="../backend/hapus_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>"
                            onclick="return confirm('Apakah anda yakin menghapus data ini?')" 
                            class="text-secondary font-weight-bold text-xs"
                            data-toggle="tooltip"
                            data-original-title="Hapus data">Hapus</a> | 
                          <a
                            href="edit_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>"
                            class="text-secondary font-weight-bold text-xs"
                            data-toggle="tooltip"
            ...
            <a class="btn bg-gradient-primary mt-4 w-30" href="tambah_petugas.php" type="button">Tambahkan Petugas</a>
          </div>
        </div>
      </div>
    </main>
