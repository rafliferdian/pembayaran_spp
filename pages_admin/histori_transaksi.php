    ...
    >
      ...
      >
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../pages_admin/histori_transaksi.php">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
            ...
            <div class="card mb-4">
              ...
              Cari Siswa<br>
                <div class="input-group">
                  <button class="input-group-text text-body" type="submit" name="cari">
              ...
              if(isset($_POST['cari'])){
                  ...
                  $queryResult = mysqli_num_rows($biodataSiswa);
                  if($queryResult > 0){
              ...
              <table cellpadding="5">
                      ...
                      <tr>
                        ...
                        <?php }else{
                          ?><td class="align-middle text-center text-sm">
                            ...
                            <td><a href="../backend/proses_bayar_lunas.php?id_pembayaran=<?=$r_trx['id_pembayaran']?>"
                                   class="badge badge-sm bg-gradient-primary">Bayar Lunas</a></td>
                        <?php } ?>
                ...
                <a href="cetak.php" type="submit" name="simpan" class="btn bg-gradient-primary mt-4 w-30">Cetak Histori Transaksi</a>
                <?php
               }
               } else{ 
                ?>
                <br>
                <h5 class="font-weight-bolder mb-0 px-1">NISN Tidak Ditemukan</h5>
                <?php 
               }
              }
                ?>
