<?php
    include "../backend/session_petugas.php";
?>
  ...
  <body class="g-sidenav-show bg-gray-100">
    ...
    >
      ...
      >
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="../pages_petugas/transaksi.php">
              <div
          ...
          <li class="nav-item">
            <a class="nav-link" href="../pages_petugas/histori_transaksi.php">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
          ...
          <div class="col-12">
            <div class="card mb-4">
              ...
              <div class="card-body px-3 pt-0 pb-2">
                ...
                <tr>
                  <td>Petugas :</td>
                  <td><select name="petugas" class="form-select">
                    <?php
                ...
                <tr>
                <td>Nama siswa :</td>
                <td><select name="siswa" class="form-select">
                  <?php
              ...
              <tr>
                <td>Tanggal pembayaran :</td>
                    <td class="input-group">
                        ...
                        <input type="text" class="form-control" name="tahun" placeholder="tahun"></td>
              </tr>
              <tr>
                <td>SPP / Nominal yang harus dibayar :</td>
                <td><select name="spp" class="form-select">
                  <?php
                  // Ambil juga data SPP
                  $spp = mysqli_query($conn, "SELECT * FROM spp ORDER BY tahun ASC");
                ...
                <tr>
                <td>Jumlah bayar :</td>
                <td><input type="text" class="form-control" name="jumlah" placeholder=""></td>
            </tr>
        </table>
                </div>
              </div>
            </div>
            <button class="btn bg-gradient-primary mt-4 w-30" type="submit" name="simpan">Lakukan Transaksi</button>
          </div>
        </div>
      </div>
    </main>
